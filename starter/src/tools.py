...
def create_calculator_tool(logger: ToolLogger):
    ...
    def calculator(expression: str) -> str:
        ...
        try:
            ...
            # Allow only basic math: +, -, *, /, numbers, parens, decimals
            # Explicitly block ** (exponentiation) before the character check
            if "**" in expression or not re.fullmatch(r"[0-9+\-*/().\s]+", expression):
                error_msg = "Invalid expression. Only basic mathematical operations are allowed."
